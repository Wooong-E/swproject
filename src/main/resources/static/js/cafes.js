document.addEventListener('DOMContentLoaded', () => {
    ...
    const fetchAndPrepareData = () => {
        ...
        const mockData = [
            ...
            { id: 201, name: '마고 포레스트', address: '경북 경산시 와촌면 계당길 100', tasteCategory: '감성', moodCategory: '힐링', imageUrl: '/images/cafes/emotional/1.svg', category: '카페', averageGrade: 5.0 },
            { id: 202, name: '안포레', address: '경북 경산시 와촌면 계당길 100-10', tasteCategory: '감성', moodCategory: '데이트', imageUrl: '/images/cafes/emotional/2.svg', category: '카페', averageGrade: 5.0 },
            { id: 203, name: '서상카페', address: '경북 경산시 서상길 10-1', tasteCategory: '감성', moodCategory: '혼공', imageUrl: '/images/cafes/emotional/3.svg', category: '카페', averageGrade: 5.0 },
            { id: 204, name: '카페 코잔타', address: '경북 경산시 와촌면 계당길 100-20', tasteCategory: '감성', moodCategory: '친구/모임', imageUrl: '/images/cafes/emotional/4.svg', category: '카페', averageGrade: 5.0 },
            { id: 205, name: '인필름', address: '경북 경산시 하양읍 하양로 100-1', tasteCategory: '감성', moodCategory: '데이트', imageUrl: '/images/cafes/emotional/5.svg', category: '카페', averageGrade: 5.0 },
            { id: 206, name: '월든', address: '경북 경산시 남천면 남천로 100-2', tasteCategory: '감성', moodCategory: '힐링', imageUrl: '/images/cafes/emotional/6.svg', category: '카페', averageGrade: 5.0 },
